...
print("Le righe sono: ",len(stringa_paragrafi))

parole = contenuto.split(' ')

print("Le parole sono: ",len(parole))
caratteri= list(contenuto)
print ('I caratteri (spazi inclusi) sono: ',len(caratteri))
no_spazi=contenuto.replace(" ","")
caratteri_no_space=list(no_spazi)
print ('I caratteri (spazi esclusi) sono: ',len(caratteri_no_space))
